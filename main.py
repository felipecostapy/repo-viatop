...
class BaseWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self._colunas_visiveis = [14, 0, 1, 2, 15, 16, 4, 5, 7, 8, 9, 18]
        COLUNAS = ["STATUS", "DATA", "FILIAL", "CLIENTE", "PEDIDO", "PRODUTO",
                   "MOTORISTA", "PLACA", "DESTINO", "UF", "PESO", "COLOCADOR", "", ""]
        self._tabela.setColumnCount(len(COLUNAS))
        self._tabela.setHorizontalHeaderLabels(COLUNAS)

        larguras = [110, 82, 60, 120, 65, 140, 110, 80, 110, 35, 50, 85, 46, 46]
    ...
    def _toggle_edicao(self, row, dados_orig):
        ...
        # col 0=STATUS(combo), 1-7 e 8-11 = QLineEdit
        # nova ordem: STATUS(0) DATA(1) FILIAL(2) CLIENTE(3) PEDIDO(4) PRODUTO(5)
        #             MOTORISTA(6) PLACA(7) DESTINO(8) UF(9) PESO(10) COLOCADOR(11)
        for c in range(12):
        ...
        # Botão OK na coluna 12, ✕ na 13
        self._tabela.setItem(row, 12, self._make_btn_item("OK",  "#2ea043"))
        self._tabela.setItem(row, 13, self._make_btn_item("✕", "#da3633"))
    ...
    def _salvar_edicao(self, row):
        ...
        # col 0=STATUS, 1=DATA, 2=FILIAL, 3=CLIENTE, 4=PEDIDO, 5=PRODUTO,
        #     6=MOTORISTA, 7=PLACA, 8=DESTINO, 9=UF, 10=PESO, 11=COLOCADOR
        vals = {}
        for c in range(12):
        ...
        try:
            ...
            bg      = QColor(bg_cor)
            novos   = [vals[c] for c in range(12)]
